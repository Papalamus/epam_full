...
namespace Test_project.DataBase.PersonConnecters
{
    public class MyOrmBase
    {
        ...
        private static MyOrmBase _instance = new MyOrmBase();


        public static MyOrmBase GetInstance()
        {
            return _instance;
        }
        ...
        public void Delete(Type type, object ID)
        {
            ...
            List<CustomizeCommandHandler> deleteQuerys = cm.DeleteCommand(ID);
            foreach (var query in deleteQuerys)
            {
                _adoHelper.ExequteNonQuery(query);    
            }
        }
        ...
        public MyOrmConnecter<T> GetConnecter<T>() where T : class, new()
        {
            ...
            return new MyOrmConnecter<T>(this);
        } 
